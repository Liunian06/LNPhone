...
class $ChatSessionsTable extends ChatSessions
  ...
  VerificationContext validateIntegrity(
    Insertable<ChatSessionEntity> instance, {
    ...
    if (data.containsKey('me_id')) {
      context.handle(
        _meIdMeta,
        meId.isAcceptableOrUnknown(data['me_id']!, _meIdMeta),
      );
    } else if (isInserting) {
  ...
  ChatSessionEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatSessionEntity(
      ...
      meId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}me_id'],
      )!,
      ...
      enableExtendedChat: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}enable_extended_chat'],
      )!,
    );
  }
...
class ChatSessionEntity extends DataClass
  ...
  factory ChatSessionEntity.fromJson(
  ...
  @override
  int get hashCode =>
      Object.hash(id, roleId, meId, lastUpdated, enableExtendedChat);
  @override
...
class $ChatMessagesTable extends ChatMessages
  ...
  ChatMessageEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatMessageEntity(
      ...
      type: $ChatMessagesTable.$convertertype.fromSql(
      ...
      metadata: $ChatMessagesTable.$convertermetadatan.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_me'] = Variable<bool>(isMe);
    {
      map['type'] = Variable<int>(
        $ChatMessagesTable.$convertertype.toSql(type),
      );
    }
...
class ChatMessagesCompanion extends UpdateCompanion<ChatMessageEntity> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] = Variable<int>(
        $ChatMessagesTable.$convertertype.toSql(type.value),
      );
    }
    if (content.present) {
...
class $MomentsPostsTable extends MomentsPosts
  ...
  mediaItems = GeneratedColumn<String>(
    'media_items',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<List<MediaItem>>($MomentsPostsTable.$convertermediaItems);
  ...
  comments = GeneratedColumn<String>(
    'comments',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<List<MomentsComment>>($MomentsPostsTable.$convertercomments);
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<MomentsPostEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  MomentsPostEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MomentsPostEntity(
      ...
      user: $MomentsPostsTable.$converteruser.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
      ...
      mediaItems: $MomentsPostsTable.$convertermediaItems.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}media_items'],
        )!,
      ),
      ...
      likes: $MomentsPostsTable.$converterlikes.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}likes'],
        )!,
      ),
      comments: $MomentsPostsTable.$convertercomments.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
...
class MomentsPostEntity extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<String>(id);
    {
      map['user'] = Variable<String>(
        $MomentsPostsTable.$converteruser.toSql(user),
      );
    }
    ...
    map['created_at'] = Variable<int>(createdAt);
    {
      map['likes'] = Variable<String>(
        $MomentsPostsTable.$converterlikes.toSql(likes),
      );
    }
    {
  ...
  factory MomentsPostEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  MomentsPostEntity copyWithCompanion(MomentsPostsCompanion data) {
    return MomentsPostEntity(
      ...
      content: data.content.present ? data.content.value : this.content,
      mediaItems: data.mediaItems.present
          ? data.mediaItems.value
          : this.mediaItems,
...
class MomentsPostsCompanion extends UpdateCompanion<MomentsPostEntity> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (user.present) {
      map['user'] = Variable<String>(
        $MomentsPostsTable.$converteruser.toSql(user.value),
      );
    }
    if (content.present) {
      map['content'] = Variable<String>(content.value);
...
final class $$ChatSessionsTableReferences
    extends
        BaseReferences<_$AppDatabase, $ChatSessionsTable, ChatSessionEntity> {
...
typedef $$ChatMessagesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool sessionId})
    >;
typedef $$MomentsPostsTableCreateCompanionBuilder =
    MomentsPostsCompanion Function({
      required String id,
      required MomentsUser user,
      Value<String?> content,
      required List<MediaItem> mediaItems,
...
typedef $$MomentsPostsTableUpdateCompanionBuilder =
    MomentsPostsCompanion Function({
      Value<String> id,
      Value<MomentsUser> user,
      Value<String?> content,
...
class $$MomentsPostsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $MomentsPostsTable,
...
typedef $$MomentsPostsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $MomentsPostsTable,
      MomentsPostEntity,
