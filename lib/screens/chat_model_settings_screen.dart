...
class ChatModelSettingsScreen extends StatelessWidget {
  const ChatModelSettingsScreen({super.key});
                  ...
                  builder: (context, provider, child) {
                    return ListView(
                      ...
                      children: [
                        ...
                        if (provider.chatPresets.isEmpty)
                          Center(
                            child: Padding(
                          ...
                          SettingsSection(
                            title: 'API 预设列表',
                            children: provider.chatPresets.map((preset) {
                              final isActive =
